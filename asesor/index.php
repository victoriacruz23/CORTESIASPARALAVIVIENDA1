        ...
        <div class="row" style="justify-content: center;">
            <div class="col-8" style="margin-top:3%;">
                <div class="table-responsive bg-white shadow-lg rounded p-4">
                    <h2 class="text-center mb-2">Afiliados</h2>
                    <table id="example" class="table table-striped table-hover" style="width:100%">
                        <thead class="table-dark">
                            <tr>
                                <th scope="col">REF_PV</th>
                                <th scope="col">REF_AHORRO</th>
                        ...
                        <tbody class="table-primary">
                            ...
                            $usuario = $conexion->conectar2()->query("SELECT REF_PV, REF_AHORRO, IdAsesor, Nombres FROM AFILIADO");
                            if ($usuario->num_rows > 0) {
                                while ($cons = $usuario->fetch_assoc()) {
                            ?>
                                    <tr>
                                        <th scope="row"><?php echo $i++; ?></th>
                                        <td><?php echo $cons["REF_PV"]; ?></td>
                                        <td><?php echo $cons["REF_AHORRO"]; ?> </td>
                                        <td><?php echo $cons["IdAsesor"]; ?> </td>
                                        <td><?php echo $cons["Nombres"]; ?> </td>
                                    </tr>
                            <?php
                                }
                            } else {
